package com.example.mart.repositpry;
...
import com.example.mart.repository.ItemRepositpry;
...
public class MartRepositoryTest {
    ...
    @Autowired
    private ItemRepositpry itemRepositpry;
    ...
    public void testOrderInsert() {
        ...
        OrderItem orderItem = OrderItem.builder()
                .item(itemRepositpry.findById(2L).get())
                .order(order)
                .orderPrice(39000)
                .count(1)
                .build();
