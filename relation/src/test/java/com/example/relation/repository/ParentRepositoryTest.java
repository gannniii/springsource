...
public class ParentRepositoryTest {
    ...
    public void testInsert2() {
        ...
        parent.getChilds().add(Child.builder().name("김민성").parent(parent).build());
        parent.getChilds().add(Child.builder().name("장미경").parent(parent).build());

        // childRepository.save(parent) 호출하지 않고도 child 저장이 일어남
